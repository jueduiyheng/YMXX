 ...
 * @author lanyj
 */
public class ChangeHairActivity extends BaseActivity implements ModelPopup.OnDialogListener {
    /***
     * 使用照相机拍照获取图片
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHairIv = (MultiTouchImageView) findViewById(R.id.hairIv);
        mListView = (HorizontalListView)findViewById(R.id.listview);
        slideMenu =  (ViewPager)findViewById(R.id.slideMenu);
        mModeIv = (ImageView) findViewById(R.id.modelIv);
        mRadioGroup = (RadioGroup) findViewById(R.id.model_radioGroup);
        layout_root = (RelativeLayout) findViewById(R.id.responsetouchContainer);
        findViewById(R.id.takephotoIv).setOnClickListener(new OnClickListener() {
            @Override
        ...
        mTopBar.mTvRight.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isMale) {
                    isMale = true;
                    mModeIv.setImageResource(R.mipmap.modelsecond);
                    mRightText = "<font color='white'><big>男/</big></font><font color='#808080'>女</font>";
                } else {
                    isMale = false;
                    mModeIv.setImageResource(R.mipmap.modelfourth);
                    mRightText = "<font color='white'><big>女/</big></font><font color='#808080'>男</font>";
                }
                mTopBar.mTvRight.setText(Html.fromHtml(mRightText));
            }
...
//                    // 选择图库图片结果
//                    String picPath = ImageUtil.getPicPathFromUri(intent.getData(), this);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (selectPos == position) {
                holder.imageView.setBackgroundResource(R.mipmap.hairview_pressed);
            } else {
