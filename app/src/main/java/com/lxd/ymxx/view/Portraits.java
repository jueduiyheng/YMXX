...
public class Portraits extends ImageView {
    ...
    public Portraits(Context context) {
    ...
    public Portraits(Context context, AttributeSet attrs) {
    ...
    public Portraits(Context context, AttributeSet attrs, int
            defStyle) {
